...
CREATE TABLE `tourist` (
  ...
  CONSTRAINT `customer_fk` FOREIGN KEY (`customerNo`) REFERENCES `customer` (`customerNo`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `tourist` VALUES (1,'Che','Tan');
